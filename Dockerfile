...
RUN apt-get update -y && \
     apt-get upgrade -y && \
     apt-get install -y openssh-server xterm xauth x11-xserver-utils libgconf-2-4 libnss3 unzip mozc-server uim uim-mozc fonts-takao firefox firefox-locale-ja
